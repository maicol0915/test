...
<body>
	...
	<section id="container">
		<form method="post" action="admin_Join">
			...
			<br>
			<div class="form-group has-feedback">
				<label class="control-label" for="AadminDept">관리자 직급 : </label> <select
					name="dept">
			...
			<br>
			<div class="form-group has-feedback">
				<label class="control-label" for="AadminGroup">사용자 그룹 : </label> <select
					name="admin_Author">
					<option value="">선택</option>
